...
print(N)
X.dat_common = X.dat %>% filter(length > 2e6)
...
saveRDS(X.dat_common, "new_data/Xdat_common.rds")
...
saveRDS(X.dat_ordered1, "new_data/Xdat_ordered1.rds")
...
saveRDS(X.dat_ordered2, "new_data/Xdat_ordered2.rds")
