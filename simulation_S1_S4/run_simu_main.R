...
load(file="data_res/V_list_100.Rdata")
...
save(res, file = "data_res/res_discrete.Rdata")
# # 
...
save(res, file = "data_res/res_continuous.Rdata")
# #
# # #
# #
...
save(res, file = "data_res/res_discrete_mispe.Rdata")
...
save(res, file = "data_res/res_discrete_mispe_block.Rdata")
